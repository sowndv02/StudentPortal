...
namespace SEP_Management.Migrations
{
    ...
    [Migration("20240314030143_initdatabase_v26")]
    partial class initdatabase_v26
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEP_Management.Models.IssueLabel", b =>
                {
                    b.Property<int>("IssueLabelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IssueLabelId"), 1L, 1);
            ...
            modelBuilder.Entity("SEP_Management.Models.Class", b =>
                {
                    b.HasOne("SEP_Management.Models.Role", "Semester")
                        .WithMany()
            ...
            modelBuilder.Entity("SEP_Management.Models.Issue", b =>
                {
                    b.HasOne("SEP_Management.Models.User", "Assignee")
                        .WithMany()
            ...
            modelBuilder.Entity("SEP_Management.Models.IssueLabel", b =>
                {
                    ...
                    b.HasOne("SEP_Management.Models.IssueSetting", "Label")
                        .WithMany("IssueLabels")
