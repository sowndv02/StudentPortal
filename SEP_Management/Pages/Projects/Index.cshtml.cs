...
namespace SEP_Management.Pages.Projects
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(SEP_ManagementContext context, Microsoft.AspNetCore.Hosting.IHostingEnvironment environment, UserManager<User> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync(int? classId)
        {
            ...
            MentorList = new SelectList(allUsers.Where(u => _userManager.GetClaimsAsync(u).Result.Any(c => c.Type == "Role" && c.Value == "PROJECT_MENTOR")), "Id", "FullName");
        ...
        public IActionResult OnPostImport()
        {
            ...
            return Redirect($"/Projects?classId={Class.ClassId}");
        }
