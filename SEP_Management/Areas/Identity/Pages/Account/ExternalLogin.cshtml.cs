...
namespace SEP_Management.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            ...
            IEmailSender emailSender, SEP_ManagementContext context)
        {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                {
                    if (Regex.IsMatch(info.Principal.FindFirstValue(ClaimTypes.Email), "fpt", RegexOptions.IgnoreCase))
                    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((externalEmail == null) && (externalEmail == Input.Email))
                {
                    ...
                    {
                        resultNewUser = await _userManager.AddLoginAsync(newUser, info);
